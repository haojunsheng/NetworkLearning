...
![img](https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost/%E8%AE%A1%E7%AE%97%E6%9C%BA%E7%BD%91%E7%BB%9C/ping/3.jpg)

------

## [#](https://xiaolincoding.com/network/4_ip/ping.html#ip协议的助手-icmp-协议)IP协议的助手 —— ICMP 协议
...
## [#](https://xiaolincoding.com/network/4_ip/ping.html#查询报文类型)查询报文类型
...
## [#](https://xiaolincoding.com/network/4_ip/ping.html#差错报文类型)差错报文类型
...
## [#](https://xiaolincoding.com/network/4_ip/ping.html#ping-查询报文类型的使用)ping —— 查询报文类型的使用
...
## [#](https://xiaolincoding.com/network/4_ip/ping.html#traceroute-差错报文类型的使用)traceroute —— 差错报文类型的使用
...
## [#](https://xiaolincoding.com/network/4_ip/ping.html#读者问答)读者问答
