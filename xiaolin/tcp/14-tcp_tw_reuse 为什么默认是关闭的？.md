...
## [#](https://xiaolincoding.com/network/3_tcp/tcp_tw_reuse_close.html#什么是-time-wait-状态)什么是 TIME_WAIT 状态？
...
## [#](https://xiaolincoding.com/network/3_tcp/tcp_tw_reuse_close.html#为什么要设计-time-wait-状态)为什么要设计 TIME_WAIT 状态？
...
#### [#](https://xiaolincoding.com/network/3_tcp/tcp_tw_reuse_close.html#原因一-防止历史连接中的数据-被后面相同四元组的连接错误的接收)原因一：防止历史连接中的数据，被后面相同四元组的连接错误的接收
...
#### [#](https://xiaolincoding.com/network/3_tcp/tcp_tw_reuse_close.html#原因二-保证「被动关闭连接」的一方-能被正确的关闭)原因二：保证「被动关闭连接」的一方，能被正确的关闭
...
## [#](https://xiaolincoding.com/network/3_tcp/tcp_tw_reuse_close.html#tcp-tw-reuse-是什么)tcp_tw_reuse 是什么？
...
## [#](https://xiaolincoding.com/network/3_tcp/tcp_tw_reuse_close.html#为什么-tcp-tw-reuse-默认是关闭的)为什么 tcp_tw_reuse 默认是关闭的？

通过前面这么多铺垫，终于可以说这个问题了。

开启 tcp_tw_reuse 会有什么风险呢？我觉得会有 2 个问题。

### [#](https://xiaolincoding.com/network/3_tcp/tcp_tw_reuse_close.html#第一个问题)第一个问题
...
### [#](https://xiaolincoding.com/network/3_tcp/tcp_tw_reuse_close.html#第二个问题)第二个问题
...
## [#](https://xiaolincoding.com/network/3_tcp/tcp_tw_reuse_close.html#总结)总结
