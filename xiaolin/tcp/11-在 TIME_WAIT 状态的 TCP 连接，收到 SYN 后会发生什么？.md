...
## [#](https://xiaolincoding.com/network/3_tcp/time_wait_recv_syn.html#先说结论)先说结论
...
### [#](https://xiaolincoding.com/network/3_tcp/time_wait_recv_syn.html#收到合法-syn)收到合法 SYN
...
### [#](https://xiaolincoding.com/network/3_tcp/time_wait_recv_syn.html#收到非法的-syn)收到非法的 SYN
...
## [#](https://xiaolincoding.com/network/3_tcp/time_wait_recv_syn.html#源码分析)源码分析
...
## [#](https://xiaolincoding.com/network/3_tcp/time_wait_recv_syn.html#在-time-wait-状态-收到-rst-会断开连接吗)在 TIME_WAIT 状态，收到 RST 会断开连接吗？
...
## [#](https://xiaolincoding.com/network/3_tcp/time_wait_recv_syn.html#总结)总结
