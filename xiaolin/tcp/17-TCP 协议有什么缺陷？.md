...
## [#](https://xiaolincoding.com/network/3_tcp/tcp_problem.html#升级-tcp-的工作很困难)升级 TCP 的工作很困难
...
## [#](https://xiaolincoding.com/network/3_tcp/tcp_problem.html#tcp-建立连接的延迟)TCP 建立连接的延迟
...
## [#](https://xiaolincoding.com/network/3_tcp/tcp_problem.html#tcp-存在队头阻塞问题)TCP 存在队头阻塞问题
...
## [#](https://xiaolincoding.com/network/3_tcp/tcp_problem.html#网络迁移需要重新建立-tcp-连接)网络迁移需要重新建立 TCP 连接
...
## [#](https://xiaolincoding.com/network/3_tcp/tcp_problem.html#结尾)结尾
