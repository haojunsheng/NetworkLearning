...
## [#](https://xiaolincoding.com/network/3_tcp/tcp_seq_ack.html#万能公式)万能公式
...
## [#](https://xiaolincoding.com/network/3_tcp/tcp_seq_ack.html#三次握手阶段的变化)三次握手阶段的变化
...
## [#](https://xiaolincoding.com/network/3_tcp/tcp_seq_ack.html#数据传输阶段的变化)数据传输阶段的变化
...
## [#](https://xiaolincoding.com/network/3_tcp/tcp_seq_ack.html#四次挥手阶段的变化)四次挥手阶段的变化
...
## [#](https://xiaolincoding.com/network/3_tcp/tcp_seq_ack.html#实际抓包图)实际抓包图

在这里贴一个，实际过程中的抓包图。

![在这里插入图片描述](https://cdn.xiaolincoding.com//mysql/other/23622630dcd14f258924c18b20e51a36.png)
