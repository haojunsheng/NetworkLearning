...
![图片](https://cdn.xiaolincoding.com//mysql/other/4e4f0d13effbeaf963992148b022ef3f.png)
...
## [#](https://xiaolincoding.com/network/3_tcp/tcp_tls.html#tcp-fast-open)TCP Fast Open
...
## [#](https://xiaolincoding.com/network/3_tcp/tcp_tls.html#tlsv1-3)TLSv1.3

> 说完 TCP Fast Open，再来看看 TLSv1.3。

在最开始的时候，我也提到 TLSv1.3 握手过程只需 1-RTT 的时间，它到整个握手过程，如下图：

![图片](https://cdn.xiaolincoding.com//mysql/other/1fd5ba4000f82613fdd70cab6da4b9cb.png)
...
## [#](https://xiaolincoding.com/network/3_tcp/tcp_tls.html#tcp-fast-open-tlsv1-3)TCP Fast Open + TLSv1.3
...
## [#](https://xiaolincoding.com/network/3_tcp/tcp_tls.html#总结)总结
