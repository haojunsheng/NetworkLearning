...
## [#](https://xiaolincoding.com/network/3_tcp/tcp_stream.html#如何理解字节流)如何理解字节流？
...
## [#](https://xiaolincoding.com/network/3_tcp/tcp_stream.html#如何解决粘包)如何解决粘包？
...
#### [#](https://xiaolincoding.com/network/3_tcp/tcp_stream.html#固定长度的消息)固定长度的消息

这种是最简单方法，即每个用户消息都是固定长度的，比如规定一个消息的长度是 64 个字节，当接收方接满 64 个字节，就认为这个内容是一个完整且有效的消息。

但是这种方式灵活性不高，实际中很少用。

### [#](https://xiaolincoding.com/network/3_tcp/tcp_stream.html#特殊字符作为边界)特殊字符作为边界
...
### [#](https://xiaolincoding.com/network/3_tcp/tcp_stream.html#自定义消息结构)自定义消息结构
