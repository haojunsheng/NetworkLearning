...
## [#](https://xiaolincoding.com/network/2_http/http3.html#美中不足的-http-2)美中不足的 HTTP/2
...
### [#](https://xiaolincoding.com/network/2_http/http3.html#队头阻塞)队头阻塞
...
![img](https://camo.githubusercontent.com/c0ac72d28a41b36aa7b7ae5a35df35452546e370a84da7936b8862fa6bb208f1/68747470733a2f2f63646e2e7869616f6c696e636f64696e672e636f6d2f67682f7869616f6c696e636f6465722f6e6574776f726b2f717569632f68747470322545392539382542422545352541312539452e6a706567)

因为 TCP 是字节流协议，TCP 层必须保证收到的字节数据是完整且有序的，如果序列号较低的 TCP 段在网络传输中丢失了，即使序列号较高的 TCP 段已经被接收了，应用层也无法从内核中读取到这部分数据，从 HTTP 视角看，就是请求被阻塞了。

举个例子，如下图：

![img](https://camo.githubusercontent.)

图中发送方发送了很多个 Packet，每个 Packet 都有自己的序号，你可以认为是 TCP 的序列号，其中 Packet 3 在网络中丢失了，即使 Packet 4-6 被接收方收到后，由于内核中的 TCP 数据不是连续的，于是接收方的应用层就无法从内核中读取到，只有等到 Packet 3 重传后，接收方的应用层才可以从内核中读取到数据，这就是 HTTP/2 的队头阻塞问题，是在 TCP 层面发生的。

### [#](https://xiaolincoding.com/network/2_http/http3.html#tcp-与-tls-的握手时延迟)TCP 与 TLS 的握手时延迟

发起 HTTP 请求时，需要经过 TCP 三次握手和 TLS 四次握手（TLS 1.2）的过程，因此共需要 3 个 RTT 的时延才能发出请求数据。

![img](https://camo.githubusercontent.)

另外，TCP 由于具有「拥塞控制」的特性，所以刚建立连接的 TCP 会有个「慢启动」的过程，它会对 TCP 连接产生“减速”效果。

### [#](https://xiaolincoding.com/network/2_http/http3.html#网络迁移需要重新连接)网络迁移需要重新连接
...
## [#](https://xiaolincoding.com/network/2_http/http3.html#quic-协议的特点)QUIC 协议的特点
...
### [#](https://xiaolincoding.com/network/2_http/http3.html#无队头阻塞)无队头阻塞
...
![img](https://camo.githubusercontent.)

### [#](https://xiaolincoding.com/network/2_http/http3.html#更快的连接建立)更快的连接建立
...
## [#](https://xiaolincoding.com/network/2_http/http3.html#总结)总结
