...
## [#](https://xiaolincoding.com/network/2_http/http_websocket.html#使用-http-不断轮询)使用 HTTP 不断轮询
...
## [#](https://xiaolincoding.com/network/2_http/http_websocket.html#长轮询)长轮询
...
## [#](https://xiaolincoding.com/network/2_http/http_websocket.html#websocket是什么)WebSocket是什么
...
### [#](https://xiaolincoding.com/network/2_http/http_websocket.html#怎么建立websocket连接)怎么建立WebSocket连接
...
### [#](https://xiaolincoding.com/network/2_http/http_websocket.html#websocket抓包)WebSocket抓包
...
### [#](https://xiaolincoding.com/network/2_http/http_websocket.html#websocket的消息格式)WebSocket的消息格式
...
### [#](https://xiaolincoding.com/network/2_http/http_websocket.html#websocket的使用场景)WebSocket的使用场景
...
## [#](https://xiaolincoding.com/network/2_http/http_websocket.html#总结)总结
