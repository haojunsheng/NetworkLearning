...
## [#](https://xiaolincoding.com/network/2_http/http_optimize.html#如何避免发送-http-请求)如何避免发送 HTTP 请求？
...
## [#](https://xiaolincoding.com/network/2_http/http_optimize.html#如何减少-http-请求次数)如何减少 HTTP 请求次数？
...
### [#](https://xiaolincoding.com/network/2_http/http_optimize.html#减少重定向请求次数)减少重定向请求次数
...
### [#](https://xiaolincoding.com/network/2_http/http_optimize.html#合并请求)合并请求
...
### [#](https://xiaolincoding.com/network/2_http/http_optimize.html#延迟发送请求)延迟发送请求
...
## [#](https://xiaolincoding.com/network/2_http/http_optimize.html#如何减少-http-响应的数据大小)如何减少 HTTP 响应的数据大小？
...
## [#](https://xiaolincoding.com/network/2_http/http_optimize.html#总结)总结
